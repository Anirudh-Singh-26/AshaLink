    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-primary/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 medical-gradient-primary rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg animate-pulse-subtle">
            <Heart className="h-8 w-8 text-white" />
          </div>
          <h1 className="text-gradient bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
            AshaLink
          </h1>
          <p className="text-muted">Your comprehensive maternal healthcare platform</p>
        </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  {registerData.role === 'patient' && (
                    <div className="grid grid-cols-3 gap-3">
                      <div className="space-y-2">
                        <Label htmlFor="register-age" className="text-sm font-medium">Age</Label>
                        <Input
                          id="register-age"
                          type="number"
                          placeholder="Age"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="register-pregnancy" className="text-sm font-medium">Weeks</Label>
                        <Input
                          ...
                          onChange={(e) => setRegisterData({ ...registerData, pregnancyDuration: e.target.value })}
                          required
                          className="focus-ring"
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="register-location" className="text-sm font-medium">Location</Label>
                        <Input
                  ...
                  {registerData.role === 'doctor' && (
                    <div className="space-y-2">
                      <Label htmlFor="register-specialization" className="text-sm font-medium">Specialization</Label>
                      <Input
                  ...
                  <Button 
                    type="submit" 
                    className={`w-full bg-gradient-to-r ${getRoleColor(registerData.role)} text-white hover:scale-105 transition-all duration-300 btn-shine focus-ring`}
                    disabled={isLoading}
                  >
                    <div className="flex items-center justify-center">
                      {getRoleIcon(registerData.role)}
                      <span className="ml-2">
                        {isLoading ? 'Creating Account...' : `Create ${registerData.role.charAt(0).toUpperCase() + registerData.role.slice(1)} Account`}
                      </span>
                    </div>
                  </Button>
                </form>
